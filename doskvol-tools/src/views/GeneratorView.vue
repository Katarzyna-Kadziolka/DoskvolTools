...
<template>
  <div class='generator-view_container'>
    <div class='generator-view_navigation'>
      ...
      <GeneratorNavigationItem :name='t("generator-navigation.scores")' icon='fa-solid fa-mask' :is-active='activeItemName === "scoresGenerator"' @click='() => onItemClick("scoresGenerator")'/>
    </div>
