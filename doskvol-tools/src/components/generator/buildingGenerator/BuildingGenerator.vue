...
<template>
  <BaseGenerator :title="t('generator-navigation.building').toLocaleUpperCase()" @generateRandom="generateRandom" @copy="copy">
    ...
    <template v-slot:results>
      <GeneratorResultElement :title="t('buildings.exterior.material.title')" :value="building.exteriorMaterial" url="buildingExteriorMaterial"/>
      <GeneratorResultElement :title="t('buildings.exterior.details.title')" :value="building.exteriorDetails" url="buildingExteriorDetails"/>
